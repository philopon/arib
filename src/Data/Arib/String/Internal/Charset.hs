...
eisuuDict    = $(mkCharset1 (SC.unpack . T.encodeUtf8) "data/Eisuu.txt")
hiraganaDict = $(mkCharset1 (SC.unpack . T.encodeUtf8) "data/Hiragana.txt")
katakanaDict = $(mkCharset1 (SC.unpack . T.encodeUtf8) "data/Katakana.txt")

utf8Config :: AribConfig B.Builder
utf8Config 
    = AribConfig
        { kanji       = dict2 $(mkCharset2 (SC.unpack . T.encodeUtf8) "data/Kanji.txt") 
        ...
        , jisKatakana = dict1 $(mkCharset1 (SC.unpack . T.encodeUtf8) "data/JisKatakana.txt")
        , jisKanji1   = dict2 $(mkCharset2 (SC.unpack . T.encodeUtf8) "data/JisKanji1.txt")
        , jisKanji2   = dict2 $(mkCharset2 (SC.unpack . T.encodeUtf8) "data/JisKanji2.txt")
        , additional  = dict2 $(mkCharset2 (SC.unpack . T.encodeUtf8) "data/Arib.txt")
